...
2. Opened **Block public access (bucket settings)** → clicked **Edit**
3. Enabled **Block all public access** (which covers all 4 underlying settings: new ACLs, all ACLs, new bucket policies, and all bucket policies)
4. Saved and confirmed the change
